...
public class MainActivity extends AppCompatActivity {
    ...
    private void initEvent() {
        ...
        mReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mQuantity.setText(String.valueOf(qty));
                mPrice.setText("Price $" + price);
                mFlavorChocolate.setActivated(false);
                mFlavorMoccha.setActivated(false);
            }
        });
    ...
    protected void sendEmail() {
        String[] TO = {"kamal.oke@gmail.com","keenanaydin@gmail.com"};
        Intent emailIntent = new Intent(Intent.ACTION_SEND);
        emailIntent.setData(Uri.parse("mailto:"));
        emailIntent.setType("text/plain");
        emailIntent.putExtra(Intent.EXTRA_EMAIL, TO);
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Order");
        emailIntent.putExtra(Intent.EXTRA_TEXT, "Nama saya " + mTextNama.getText() + ", saya memesan"
            + mMenu.getSelectedItem() + " sebanyak " + mQuantity.getText() + " seharga " + price);
