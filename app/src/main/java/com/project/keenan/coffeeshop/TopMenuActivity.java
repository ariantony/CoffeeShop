...
public class TopMenuActivity extends AppCompatActivity {
    ...
    String[] menuArray = {"Moccachino","Frappucino","Robusta","Kopi Lampung","Arabica","Kopi Luwak","Cortado","Flat White","Cafe Cubano","Espresso"};
    ...
    // ctrl shift untuk pindah yg diblok
    @Override
